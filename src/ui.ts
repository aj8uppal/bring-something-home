...
export function shell() {
  ...
  <main id="title-screen" class="title-screen">
    ...
    <footer class="title-footer"><span>${icon('compass')} WASD to move <i>·</i> Mouse to aim <i>·</i> Courage to continue</span><button data-panel="realms"><span class="live-dot"></span><span id="realm-status">Connecting to the Hearth</span>${icon('chevron')}</button><span class="version">BRING SOMETHING HOME / 1.5</span></footer>
  </main>
